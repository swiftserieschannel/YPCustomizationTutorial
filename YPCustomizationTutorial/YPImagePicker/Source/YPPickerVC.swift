...
open class YPPickerVC: YPBottomPager, YPBottomPagerDelegate {
    ...
    private var newVC: NewViewController?
    ...
    open override func viewDidLoad() {
        ...
        if YPConfig.screens.contains(.newVC){
            newVC = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(identifier: "NewViewController")
        }
